...
export class ProductDetailStateService{
  ...
  state = signalSlice({
    ...
    // sources:[
    // ],
    // actionSources:acciones para llenar el estado , cambiar nuestros estado o llamar a otros servicios , osea el actione basicamente es para devolver valores pero el actionSources mapea segun algun valor en este caso es el  getById
    actionSources: {
